...
def obtain_model_names_and_classes(model_name='roberta', model_type='roberta-base'):
    ...
    types_of_models=[{'bert':['bert-base-uncased']},{'xlm':['xlm-mlm-en-2048']},{'roberta':['roberta-base']},{'bart':["facebook/bart-base"]},{'longformer':['allenai/longformer-base-4096']},{'albert':['albert-xxlarge-v2']},{'electra':['google/electra-large-generator']},{'reformer':['google/reformer-crime-and-punishment']},{'mobilebert':['mobile']},{'scibert':['allenai/scibert_scivocab_uncased']}]
    print("Choose from the list of models and their respective pretrained versions:")
    print(types_of_models)
    model_with_no_token_types =['roberta', 'bart' ,'longformer','albert','electra','reformer','mobilebert','scibert']
